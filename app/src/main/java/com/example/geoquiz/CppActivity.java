...
public class CppActivity extends AppCompatActivity {
    ...
    private static final String TAG = "CppActivity";
    ...
    private Question[] mQuestionBank = new Question[] {
            new Question(R.string.question2_one,false),
            new Question(R.string.question2_two,true),
            new Question(R.string.question2_three,true),
            new Question(R.string.question2_four,true),
            new Question(R.string.question2_five,true),
            new Question(R.string.question2_six,false),
            new Question(R.string.question2_seven,false),
            new Question(R.string.question2_eight,true),
            new Question(R.string.question2_nine,false),
            new Question(R.string.question2_ten,true),
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCheatButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                boolean answerIsTrue=mQuestionBank[mCurrentIndex].isAnswerTrue();
                Intent intent = CheatActivity.newIntent(CppActivity.this, answerIsTrue);
    ...
    public void resultPage() {
        Intent intent = new Intent(CppActivity.this, Output.class);
